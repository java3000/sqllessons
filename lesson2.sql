...
CREATE TABLE `_cities` (
  ...
  PRIMARY KEY (`city_id`),
  KEY `idx_title` (`title`),
  KEY `fk_cou_id_idx` (`country_id`),
  CONSTRAINT `fk_cou_id` FOREIGN KEY (`country_id`) REFERENCES `_countries` (`country_id`)
...
CREATE TABLE `_regions` (
  ...
  KEY `fk_reg_cou_idx` (`country_id`) /*!80000 INVISIBLE */,
  KEY `reg_title` (`title`),
  CONSTRAINT `fk_reg_cou` FOREIGN KEY (`country_id`) REFERENCES `_countries` (`country_id`)
...
-- Dump completed on 2021-02-21  3:09:22
